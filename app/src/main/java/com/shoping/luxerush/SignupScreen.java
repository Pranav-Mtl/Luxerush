...
public class SignupScreen extends AppCompatActivity implements View.OnClickListener ,GoogleApiClient.OnConnectionFailedListener {
    ...
    TextView tvLogin;
    EditText etName, etEmail, etPhone, etPassowrd;
    Button btnDone;
    ...
    private void initialize() {
        ...
        etPhone = (EditText) findViewById(R.id.signup_mobile);
        etPassowrd = (EditText) findViewById(R.id.signup_password);
        ...
        switch (v.getId()) {
            ...
            case R.id.signup_done:
                if(validate()){
                    ...
                    objSignupBE.setEmail(strEmail);
                    objSignupBE.setMobile(strMobile);
                    objSignupBE.setPassword(strPassword);
                    objSignupBE.setGcm("");
                    objSignupBE.setDevice("");
    ...
    private class CallWS extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            String result = objSignupBL.signupEmail(getApplicationContext(), objSignupBE);
            return result;
        }
            ...
            try {
                    if(Constant.WS_RESPONSE_SUCCESS.equalsIgnoreCase(s)){
                        ...
                        Snackbar snack = Snackbar.make(findViewById(R.id.login_root),
                                getResources().getString(R.string.signup_fail),
                                Snackbar.LENGTH_LONG).setText(getResources().getString(R.string.signup_fail)).setActionTextColor(getResources().getColor(R.color.golden));
    ...
    private boolean validate() {
        ...
        strMobile = etPhone.getText().toString();
        strPassword = etPassowrd.getText().toString();
