...
/**
 * Created by Pranav Mittal on 11/17/2015.
 */
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder>  {
        ...
        public ViewHolder(View itemView, int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if (ViewType == TYPE_ITEM) {
               // Creating ImageView object with the id of ImageView from item_row.xml
                ...
                //profile= (ImageView) itemView.findViewById(R.id.drawer_image);
    ...
    public DrawerAdapter(String Titles[], int Icons[], String Name, Context context) { // MyAdapter Constructor with titles and icons parameter
        ...
        if (holder.Holderid == 1) {                              // as the list view is going to be called after the header view so we decrement the
          ...
          /*  if(profilePic.trim().length()>0){
                ...
                Picasso.with(mContext)
                        .load(Constant.IMAGE_URL+"/"+profilePic)
                        .resize(100,100)
